        ...
        try:
            ...
            if mouse_quest_level != 3:
                await h_say(
                    ...
                    chat_id,
                    [
                        'Тигр, по-моему "Виличайший рыбак, а также его друг, просто Ёжик" пишется как-то по-другому. Давай лучше Мышка запишет...'
                    ],
                )
                await m_say(
                    bot,
                ...
                await t_say(
                    ...
                    chat_id,
                    [
                        "Эх, жалко что Мышка не может сейчас записать наши параметры приключения",
                        "Попробую сам...",
                        "Ёжик почти совсем круглый, сколько же в нём червей..?",
                        "Ёжик, а ты зачем записываешь колчество рыбы, которое я не поймал?",
                    ],
                )
