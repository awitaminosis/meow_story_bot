...
@dp.message(F.text == t_go_to_tiger_home)
...
@dp.message(F.text == t_take_the_rods)
...
@dp.message(F.text == t_go_to_hedgehog_home)
...
@dp.message(F.text == t_dig_for_worms)
...
@dp.message(F.text == t_go_fishing)
...
@dp.message(F.text == t_go_fish_in_river)
@dp.message(F.text == t_go_fish_in_sea)
...
@dp.message(F.text == t_go_fish_in_pool)
